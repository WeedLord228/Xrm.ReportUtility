using System;
using System.Linq;
using Xrm.ReportUtility.handlers;
...
namespace Xrm.ReportUtility
{
    public static class Program
    {
        ...
        /*private static IReportService GetReportService(string[] args) //переделан на COR
        {
        ...
        private static void PrintReport(Report report) //Здесь можно использовать 
        {
